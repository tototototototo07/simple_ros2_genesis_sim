...
def generate_launch_description():    
    ...
    packege_name: str = 'snake_sim'
    model_path = PathJoinSubstitution([FindPackageShare(packege_name), 'config', 'model', 'urdf', 'snake_32jnt.urdf'])
    ...
    control_gui_node = Node(
        package='snake_controller_gui',
        executable='snake_controller_gui',
        output='screen',
    )
